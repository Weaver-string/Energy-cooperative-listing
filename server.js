...
const OFFICIAL_COOP_PROFILES = [
  ...
  {
    id: "bristol-energy-cooperative",
    accountId: "official-directory-bristol-energy-cooperative",
    name: "Bristol Energy Cooperative",
    initials: "BE",
    city: "Bristol",
    ...
    assets: [
      {
        type: "Solar",
        detail: "Community-owned solar projects and local energy projects.",
        value: "25 solar projects",
      },
    ],
    memberCost: "",
    electricityCost: "",
  ...
  {
    id: "ews-schoenau",
    accountId: "official-directory-ews-schoenau",
    name: "EWS Elektrizitätswerke Schönau eG",
    initials: "EWS",
    city: "Schönau im Schwarzwald",
    country: "Germany",
    intro:
      "German energy cooperative and green electricity supplier rooted in Schönau, with cooperative membership and renewable-energy activity.",
    members: 15000,
    capacity: 0,
    listingGoals: ["members"],
    openMembers: true,
    status: "Customer membership",
    publicContact: "genossenschaft@ews-schoenau.de",
    assets: [
      {
        type: "Renewable energy",
        detail: "Green electricity supply and renewable generation activity.",
        value: "",
      },
    ],
    memberCost: "",
  ...
  {
    id: "zeeuwind",
    accountId: "official-directory-zeeuwind",
    name: "Zeeuwind",
    initials: "ZW",
    city: "Vlissingen",
    country: "Netherlands",
    intro:
      "Zeeland-based cooperative wind energy association with member participation in local wind and energy projects.",
    members: 3300,
    capacity: 0,
    listingGoals: ["members"],
    openMembers: true,
    status: "Open membership",
    publicContact: "info@zeeuwind.nl",
    assets: [
      {
        type: "Wind",
